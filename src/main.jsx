...
function App() {
  ...
  const analyze = async (event) => {
    ...
    try {
      ...
      setState((s) => ({ ...s, stats, points, level: nextProgression.level, logs: [{ date: new Date().toLocaleDateString('ja-JP'), note, category, scoreChange, tip: result.tip }, ...s.logs].slice(0, 20) }));
